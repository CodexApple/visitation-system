        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('division_id')
                    ...
                    ->label('Division')
                    ->native(false)
                    ->options(Division::orderBy('name')->get(['id', 'name'])->pluck('name', 'id'))
                    ->required()
                    ->createOptionForm([
                        Forms\Components\TextInput::make('name')
                            ->required()
                    ...
                    ->createOptionUsing(fn (array $data) => Division::create($data)->id),
                Forms\Components\Select::make('designation_id')
                    ...
                    ->label('Designation')
                    ->native(false)
                    ->options(Designation::orderBy('name')->get(['id', 'name'])->pluck('name', 'id'))
                    ->required()
                    ->createOptionForm([
                        Forms\Components\TextInput::make('name')
                            ->required()
